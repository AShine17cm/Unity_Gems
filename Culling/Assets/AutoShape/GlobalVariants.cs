...
public class GlobalVariants
{
    ...
    public static Dictionary<int, Part> variants = new Dictionary<int, Part>(128);
    public static GameObject errorGo;
    //public static Dictionary<int, GameObject> variantGoes = new Dictionary<int, GameObject>(128);
