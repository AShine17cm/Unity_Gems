...
public class FastFourierTransform
{
    ...
    public void FFT2D(RenderTexture input, RenderTexture buffer, bool outputToInput = false)
    {
        ...
        for (int i = 0; i < logSize; i++)
        {
            ...
            fftShader.Dispatch(KERNEL_HORIZONTAL_STEP_FFT, size / WORK_GROUPS_X, size / WORK_GROUPS_Y, 1);
        }
        ...
        for (int i = 0; i < logSize; i++)
        {
            ...
            fftShader.SetInt(PROP_ID_STEP, i);
            fftShader.SetBool(PROP_ID_PINGPONG, pingPong);
            fftShader.Dispatch(KERNEL_VERTICAL_STEP_FFT, size / WORK_GROUPS_X, size / WORK_GROUPS_Y, 1);
        }
    ...
    public void IFFT2D(RenderTexture input, RenderTexture buffer, bool outputToInput = false, bool scale = true, bool permute = false)
    {
        ...
        for (int i = 0; i < logSize; i++)
        {
            ...
            fftShader.SetInt(PROP_ID_STEP, i);
            fftShader.SetBool(PROP_ID_PINGPONG, pingPong);
            fftShader.Dispatch(KERNEL_HORIZONTAL_STEP_IFFT, size / WORK_GROUPS_X, size / WORK_GROUPS_Y, 1);
        }
        ...
        for (int i = 0; i < logSize; i++)
        {
            ...
            fftShader.SetInt(PROP_ID_STEP, i);
            fftShader.SetBool(PROP_ID_PINGPONG, pingPong);
            fftShader.Dispatch(KERNEL_VERTICAL_STEP_IFFT, size / WORK_GROUPS_X, size / WORK_GROUPS_Y, 1);
        }
        ...
        if (permute)
        {
            ...
            fftShader.Dispatch(KERNEL_PERMUTE, size / WORK_GROUPS_X, size / WORK_GROUPS_Y, 1);
        }
        ...
        if (scale)
        {
            ...
            fftShader.Dispatch(KERNEL_SCALE, size / WORK_GROUPS_X, size / WORK_GROUPS_Y, 1);
        }
    }
    ...
    RenderTexture PrecomputeTwiddleFactorsAndInputIndices()
    {
        ...
        fftShader.Dispatch(KERNEL_PRECOMPUTE, logSize, size / 2 / WORK_GROUPS_Y, 1);
        return rt;
    }
