...
public class ShowIfNotZero : MaterialPropertyDrawer
{
    ...
    public ShowIfNotZero(string name1)
    {
        argValue = new[] {name1};
    }

    public ShowIfNotZero(string name1, string name2)
    {
        ...
        for (int i = 0; i < editor.targets.Length; i++)
        {
            ...
            if (mat != null)
            {
                ...
                for (int j = 0; j < argValue.Length; j++)
                    bElementShow |= (mat.GetFloat(argValue[j]) != 0);
            }
        }
