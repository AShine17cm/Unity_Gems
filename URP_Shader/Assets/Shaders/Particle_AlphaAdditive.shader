...
Shader "SC/Particles/fx_AlphaAdditive" {
Properties {
	...
	_BaseAlphaLerp("Base Alpha Lerp", Range(0,1)) = 1.0
	...
	SubShader {
		Pass {
			...
			half4 frag (v2f i) : COLOR
			{
				...
				half baseAlpha = lerp(texColor.a, 1.0, _BaseAlphaLerp);
