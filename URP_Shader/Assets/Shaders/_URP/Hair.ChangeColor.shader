Shader "_URP/Hair.ChangeColor"
{
    Properties
    {
        ...
        _ChangeColor ("Hair Color", Color) = (1, 1, 1, 0)
    ...
    #include "HairInput.ChangeColor.hlsl"
    ENDHLSL
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment LitFrag1

            #include "HairLitPass_New.hlsl"
            ENDHLSL
        }
          Pass
        {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "SimpleLitForwardPass_New.hlsl"
