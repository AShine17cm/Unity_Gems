Shader "_URP/Lit.Alpha.Reflection"
{
    Properties
    {
        ...
        _PatternMap("Pattern Map, Smoothness(A)", 2D) = "black" {}
         [Header(EnvironmentMap)]
         _EnableEnvironmentMap("EnableEnvironmentMap", Float) = 0.0
        [NoScaleOffset]_EnvironmentMap("Environment CubeMap",Cube) = "_Skybox"{}
        _EnvExposure ("环境高光强度", Range(0, 1)) = 0.96
        _PunctualLightSpecularExposure("高光强度",Range(1, 10))=1
        _EnvironmentColor ("Environment Color", Color) = (0, 0, 0, 0)
    ...
    CustomEditor "URP.Editor.LitAlphaShaderGUI"
}
