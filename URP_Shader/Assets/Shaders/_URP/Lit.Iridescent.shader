Shader "_URP/Lit.Iridescent"
{
    Properties
    {
        ...
        // [Header(ThinFilm)]
        _MaskMap("Separate lit or Iridescence",2D) = "white" {}
    ...
    #include "LitInput_Iridescent.hlsl"
    ENDHLSL
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "LitForwardPass_Iridescent.hlsl"
            ENDHLSL
        }
    ...
    CustomEditor "URP.Editor.Lit_IridescenceShaderGUI"
}
